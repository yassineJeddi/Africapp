 ...
 */
@Entity
public class DocumentDetailAt implements Serializable {
    ...
    public String toString() {
        return "DocumentDetailAt{" + "id=" + id + ", chemin=" + chemin + ", detailAT=" + detailAT + ", titre=" + titre + ", description=" + description + ", creePar=" + creePar + ", dateCreation=" + dateCreation + ", nbrjour=" + nbrjour + ", dateFiche=" + dateFiche + '}';
    }
