...
@ManagedBean
@ViewScoped
public class ComplementSalarieDocMb implements Serializable {
    ...
    private List<String> docsOfSalarie = new LinkedList<>();
    ...
    public List<String> getDocsOfSalarie() {
        return docsOfSalarie;
    }

    public void setDocsOfSalarie(List<String> docsOfSalarie) {
        this.docsOfSalarie = docsOfSalarie;
    }
    ...
    public String getAddSalarieNom ()
    {
    return addSalarie.getNom();
    }
    ...
    public void init() {
       ...
       idSalarie = Integer.valueOf(requestParameters.get("salarieId"));
         }
        Salarie salarie = salarieService.getSalarie(idSalarie);
        
        setAddSalarie(salarie);
        docsOfSalarie = new LinkedList<>();
        System.out.println("SALARIE COMPLETEZ DOCUMENT : " + addSalarie.getNom());
        for(Document doc : addSalarie.getDocuments()){
            System.out.println("DOCUMENT DE SALARIE : " + doc.getTypeDocument().getTypeDocument());
            docsOfSalarie.add(doc.getTypeDocument().getTypeDocument());
        }
    ...
    public boolean checkIfDocExists(String docType){
    if(docsOfSalarie.contains(docType)){
    return true;
    }
    else{
    return false;
    ...
    public String documentSalarie(Integer idSalarie) {
        ...
        return "completerdossier.xhtml?faces-redirect=true";
    }
