...
@ManagedBean
@RequestScoped
public class ValidatorMatriculeMb implements Validator {
     ...
     */
    public ValidatorMatriculeMb() {
    }
    private static final String EMAIL_EXISTE_DEJA = "Ce Matricule n'existe pas !!! ";
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        try {
            if (salarieService.getSalarie(matricule, "", "", "", "") != null) {
