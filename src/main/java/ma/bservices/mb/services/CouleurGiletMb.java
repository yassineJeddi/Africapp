...
@ManagedBean
@ApplicationScoped
public class CouleurGiletMb implements Serializable {

    @ManagedProperty(value = "#{parametrageService}")
    private ParametrageService parametrageService;
    private List<CouleurGilet> gilets;

    public CouleurGiletMb() {
    }
    ...
    public List<CouleurGilet> getGilets() {
        return gilets;
    }

    public void setGilets(List<CouleurGilet> gilets) {
        this.gilets = gilets;
    }
    ...
    public void init() {
        ...
        gilets = parametrageService.listeCouleurGilets(0, Integer.parseInt(parametrageService.nombreCouleurGilets("").toString()), "");
    }
