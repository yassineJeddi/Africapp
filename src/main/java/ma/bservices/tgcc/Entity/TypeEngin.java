 ...
 */
@Entity
public class TypeEngin implements Serializable {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TypeEngin)) {
            return false;
        }
        TypeEngin other = (TypeEngin) object;
    ...
    public String toString() {
        return "TypeEngin{" + "id=" + id + ", typeEngin=" + typeEngin + '}';
    }
